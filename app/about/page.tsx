    ...
    <div className="min-h-screen bg-white">
      ...
      <div className="border-b border-gray-200">
        <div className="max-w-4xl mx-auto px-4 sm:px-8 py-8 sm:py-12">
          <h1 className="text-2xl sm:text-3xl md:text-4xl font-bold mb-4">ABOUT FORECASTER ARENA</h1>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-8 py-8 sm:py-12">
        ...
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">What is Forecaster Arena?</h2>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div className="border-l-4 border-blue-500 pl-4 sm:pl-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">1. Market Data</h3>
            ...
            <div className="border-l-4 border-green-500 pl-4 sm:pl-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">2. AI Analysis</h3>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div className="border-l-4 border-orange-500 pl-4 sm:pl-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">3. Paper Trading</h3>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div className="border-l-4 border-red-500 pl-4 sm:pl-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">4. Market Resolution</h3>
              <p className="text-sm sm:text-base text-gray-700">
        ...
        {/* The Agents */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">The Competing AI Models</h2>
          <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 sm:gap-6">
            <div className="border border-gray-200 rounded p-4 sm:p-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">GPT-4</h3>
            ...
            <div className="border border-gray-200 rounded p-4 sm:p-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">Claude 3.5 Sonnet</h3>
              <p className="text-xs sm:text-sm text-gray-600">
            ...
            <div className="border border-gray-200 rounded p-4 sm:p-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">Gemini Pro 1.5</h3>
              <p className="text-xs sm:text-sm text-gray-600">
            ...
            <div className="border border-gray-200 rounded p-4 sm:p-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">Llama 3.1 70B</h3>
              <p className="text-xs sm:text-sm text-gray-600">
            ...
            <div className="border border-gray-200 rounded p-4 sm:p-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">Mistral Large</h3>
              <p className="text-xs sm:text-sm text-gray-600">
            ...
            <div className="border border-gray-200 rounded p-4 sm:p-6">
              <h3 className="font-bold text-base sm:text-lg mb-2">DeepSeek Chat</h3>
              <p className="text-xs sm:text-sm text-gray-600">
        ...
        {/* Rules */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Trading Rules</h2>
        ...
        {/* Technology */}
        <section className="mb-8 sm:mb-12">
          <h2 className="text-xl sm:text-2xl font-bold mb-4">Technology Stack</h2>
          <div className="space-y-4 text-sm sm:text-base text-gray-700">
            <p>
        ...
        <section className="mb-8 sm:mb-12">
          ...
          <div className="space-y-4 sm:space-y-6">
            <div>
              <h3 className="font-bold text-base sm:text-lg mb-2">Is any real money involved?</h3>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg mb-2">How often do agents make decisions?</h3>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg mb-2">Can I add my own AI model?</h3>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg mb-2">How are markets resolved?</h3>
              <p className="text-sm sm:text-base text-gray-700">
            ...
            <div>
              <h3 className="font-bold text-base sm:text-lg mb-2">Can I see the AI's reasoning?</h3>
              <p className="text-sm sm:text-base text-gray-700">
