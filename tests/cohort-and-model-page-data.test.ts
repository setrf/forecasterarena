  ...
  it('normalizes payloads and preserves cohort error messages', async () => {
    vi.stubGlobal('fetch', vi.fn()
      .mockResolvedValueOnce(mockResponse(true, {
        ...
        agents: [{ id: 'a1', model_id: 'openai-gpt', model_slug: 'openai-gpt', legacy_model_id: 'gpt-5.1', model_display_name: 'GPT', model_color: '#10B981', cash_balance: 10000, total_invested: 0, status: 'active', total_value: 10000, total_pnl: 0, total_pnl_percent: 0, brier_score: null, position_count: 0, trade_count: 0, num_resolved_bets: 0 }],
