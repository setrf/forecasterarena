...
const CHANGELOG: ChangelogEntry[] = [
  {
    version: 'v2',
    date: '2026-04-22',
    title: 'Portfolio-Value Methodology',
    description: 'Forecaster Arena now frames the benchmark as a reality-grounded LLM evaluation ranked by paper portfolio value.',
    changes: [
    ...
    effectiveFrom: 'First cohort started after v2 deployment'
  },
  {
    version: 'v1',
    date: '2024-01-01',
    ...
    effectiveFrom: 'Cohort #1'
  }
];

function formatChangelogDate(date: string) {
