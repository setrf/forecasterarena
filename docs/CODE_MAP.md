...
| Review OpenRouter model upgrades | [`POST /api/admin/benchmark/reviews/check`](../app/api/admin/benchmark/reviews/check/route.ts) | catalog review | [`lib/application/admin-benchmark/modelLineupReview.ts`](../lib/application/admin-benchmark/modelLineupReview.ts), [`lib/db/queries/model-lineup-reviews.ts`](../lib/db/queries/model-lineup-reviews.ts) |
...
| Check model lineup | [`POST /api/cron/check-model-lineup`](../app/api/cron/check-model-lineup/route.ts) | OpenRouter public model catalog | [`lib/application/cron/checkModelLineup.ts`](../lib/application/cron/checkModelLineup.ts), [`lib/application/admin-benchmark/modelLineupReview.ts`](../lib/application/admin-benchmark/modelLineupReview.ts) |
